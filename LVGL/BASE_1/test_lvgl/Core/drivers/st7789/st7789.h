...
#ifndef DRIVERS_ST7789_ST7789_H_
#define DRIVERS_ST7789_ST7789_H_
...
#include "../drivers/st7789/colors.h"
 ...
 * and use them below
 *
 * 	ST7789_RST_Pin 			GPIO_PIN_9
	ST7789_RST_GPIO_Port 	GPIOD
	ST7789_DC_Pin 			GPIO_PIN_10
	ST7789_DC_GPIO_Port		GPIOD
	ST7789_BLK_Pin 			GPIO_PIN_11
	ST7789_BLK_GPIO_Port 	GPIOD
	ST7789_CS_Pin 			GPIO_PIN_12
...
#elif LCD_ROTATION == 2				//  use Normally on 240x240
...
#define ST7789_BLK_OPEN() HAL_GPIO_WritePin(ST7789_BLK_GPIO_Port, ST7789_BLK_Pin, GPIO_PIN_SET)
#define ST7789_BLK_CLOSE() HAL_GPIO_WritePin(ST7789_BLK_GPIO_Port, ST7789_BLK_Pin, GPIO_PIN_RESET)
